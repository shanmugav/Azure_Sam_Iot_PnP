...
## Pre Usecase transaction Steps
 ...
 - Setup Azure account. Follow the instructions at [**Azure demo account setup**](../../../docs/Azure_demo_account_setup.html)
 - Ensure *Azure_iot_hub_details.csv* in [TPDS_core/Docs](../../../docs) contains the account credentials.
